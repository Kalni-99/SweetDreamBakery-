    ...
    <div class="col-md-12" style="border: solid #D9D9D9 1px; padding: 10px; padding-top: 5px; box-shadow: #9F9F9F 2px 3px 5px; margin-top: 10px;">
        <div class="panel panel-success">
            <div class="panel-heading panel-title">
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-cog"></i> Sweet Dreams Bakery Listing</span>
            </div>
            <div class="panel-body" style="background-color:#fff;">
                ...
                <div class="col-lg-6">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td style="text-align:right; font-weight:bold;">Food Name* : &emsp;</td>
                                <td style="text-align:center;">&emsp; <textarea class="form-control" name="cnpname" required></textarea></td>
                            </tr>
                            <tr>
                                <td style="text-align:right;font-weight:bold;">Prize* : &emsp;</td>
                            ...
                            <tr style="margin-top:20px;">
                                <td style="text-align:right;font-weight:bold;" colspan="2"><br />
                                    <p></p>
...
if (isset($_POST['save'])) {
    ...
    if (empty($name) || empty($prize) || empty($des) || empty($stat)) {
        ...
        $sql = mysql_query("INSERT INTO tblcnp VALUES(NULL,'$name','$prize','$des','$location','$stat')") or die(mysql_error());
        if ($sql == true) {
