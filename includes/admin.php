...
<head>
    ...
    <title>ADMIN | Sweet Dreams Bakery</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    <li class="dropdown"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> CakenPastries Module<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="addcnp.php"> Add CakenPastries </a></li>
                            <li><a href="update_cnp.php"> Update CakenPastries </a></li>
                        </ul>
                    </li>
            ...
            <table class="table table-hover table-condensed wow fadeInDown">
                ...
                <tbody id="tablebody">
                    ...
                    $query = mysql_query("SELECT tblcnp.*,tblorders.* 
											...
											tblcnp ON tblorders.cnpoid = tblcnp.id WHERE tblorders.ostatus = 'New' order by tblorders.id LIMIT 0,30 ") or die(mysql_error());
                                        ...
                                        <form method="post" action="">
                                            <div class="modal-body" id="div1">
                                                ...
                                                <dl class="dl-horizontal wow fadeInDown" style="text-align:left">
                                                    ...
                                                    <dt>Prize:</dt>
                                                    <dd><?php echo 'P ' . $row['prize']; ?></dd>
                                                    <dt>Qty:</dt>
                                                    <dd><?php echo $row['oqty']; ?></dd>
                                                    <dt>Total:</dt>
                                                    <dd><?php echo 'P ' . number_format($total, 2, '.', ','); ?></dd>
                                                    <hr style="border-top: 1px dashed #8c8b8b;
	border-bottom: 1px dashed #fff;">
                                                    <dt><em>Customer Details</em></dt>
                                                    <dd></dd>
                                                    <dt>Ordered by:</dt>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" onClick="printContent('div1');" class="btn btn-info wow fadeInDown"><i class="glyphicon glyphicon-print"></i> Print</button>
    ...
    if (isset($_POST['deliver'])) {
        $id = $_POST['fdid'];
        $sql = mysql_query("UPDATE tblorders set ostatus = 'Completed' WHERE id = '$id'") or die(mysql_error());
        if ($sql == true) {
        ...
        $id = $_POST['fdid'];
        $sql = mysql_query("UPDATE tblorders set ostatus = 'Cancel' WHERE id = '$id'") or die(mysql_error());
        if ($sql == true) {
            echo "<script> location.replace('index.php'); </script>";
        }
    }
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2021 Sweet Dreams Bakery. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer>
